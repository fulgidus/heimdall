...
- [ ] **Task 1**: Create migration SQL script `04-add-rbac-schema.sql`
...
- [ ] **Task 13**: Create data migration script
...
- [ ] **Task 2**: Create Constellation models
  - `Constellation` model
...
- [ ] **Task 6**: Create RBAC utility module
  ...
  - **Files**: `services/common/auth/rbac.py`
  - **Status**: ⏳ Pending
...
- [ ] **Task 8**: Create Constellation CRUD router
...
- [ ] **Task 9**: Create Constellation sharing endpoints
...
- [ ] **Task 10**: Update sessions router
...
- [ ] **Task 11**: Create/update Sources router
...
- [ ] **Task 12**: Create/update Models router
...
### Completed Tasks
_None yet - just started!_

### In Progress
- [ ] Task 0: Create RBAC_IMPLEMENTATION.md (this document)

### Blocked
_None currently_

### Next Up
1. Task 1: Database migration SQL script
2. Task 2: SQLAlchemy models for Constellation
3. Task 6: RBAC utilities in common/auth/rbac.py
