...
CREATE INDEX IF NOT EXISTS idx_training_jobs_status ON training_jobs(status, created_at DESC);
CREATE INDEX IF NOT EXISTS idx_training_jobs_celery_task ON training_jobs(celery_task_id);
...
CREATE INDEX IF NOT EXISTS idx_training_metrics_job ON training_metrics(training_job_id, timestamp DESC);
CREATE INDEX IF NOT EXISTS idx_training_metrics_epoch ON training_metrics(training_job_id, epoch);
