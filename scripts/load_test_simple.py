...
def analyze_results(task_data: List[Dict]) -> Dict:
    ...
    analysis = {
        ...
        "submission_latency_ms": {
            ...
            "p95": sorted(submission_times)[int(len(submission_times) * 0.95)] if submission_times else 0,
            "p99": sorted(submission_times)[int(len(submission_times) * 0.99)] if submission_times else 0,
        }
    }
