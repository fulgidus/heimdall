...
fixes = {
    ...
    "fixes": [
        ...
        },
        {
            ...
            "files_changed": ["services/rf-acquisition/tests/integration/test_minio_storage.py"],
            "status": "✅ FIXED",
        },
        {
            "id": 3,
            ...
            "files_changed": [".github/workflows/ci-test.yml"],
            "status": "✅ FIXED",
        },
        {
            "id": 4,
            ...
            "files_changed": ["conftest.py (created)"],
            "status": "✅ FIXED",
        },
        {
            "id": 5,
