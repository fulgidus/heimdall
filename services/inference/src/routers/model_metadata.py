...
class ModelInfoResponse(BaseModel):
    ...
    latency_p95_ms: Optional[float] = Field(None, description="95th percentile latency")
...
class ModelReloadRequest(BaseModel):
    ...
    version_id: Optional[str] = Field(None, description="Specific version to load")
    stage: Optional[str] = Field(default="Production", description="Model stage")
...
class ReloadState:
    ...
    reload_start_time: Optional[datetime] = None
