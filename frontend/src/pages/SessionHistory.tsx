                        ...
                        {sessions.map(session => (
                          ...
                          >
                            <td>
                              ...
                              {session.notes && (
                                <p
                                  className="text-muted f-12 mb-0 text-truncate"
                    ...
                    <table className="table table-sm">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {selectedSessionData.source_frequency
                              ? (selectedSessionData.source_frequency / 1e6).toFixed(3) + ' MHz'
                              : 'N/A'}
                          </td>
                        </tr>
                        <tr>
                          ...
                          <td>
                            {selectedSessionData.started_at
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span
                              className={`badge ${
                                selectedSessionData.approval_status === 'approved'
                                  ? 'bg-light-success'
