...
const DataIngestion: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const loadData = async () => {
      setPageLoading(true);
      try {
        await Promise.all([fetchKnownSources(), fetchSessions(), fetchAnalytics()]);
      } finally {
            ...
            <div className="card-body">
              ...
              <div className="bg-body p-2 mt-2 rounded">
                <div className="d-flex align-items-center justify-content-between">
                  ...
                  <span
                    className={`badge ${successRate > 80 ? 'bg-light-success' : successRate > 60 ? 'bg-light-warning' : 'bg-light-danger'}`}
                  >
                          ...
                          {knownSources.map(source => (
                            <tr key={source.id}>
                              <td>
                                <div className="d-flex align-items-center">
                                  <div
                                    className={`avtar avtar-xs ${source.is_validated ? 'bg-light-success' : 'bg-light-warning'}`}
                                  >
                              ...
                              <td className="d-none d-lg-table-cell">
                                {source.power_dbm ? `${source.power_dbm} dBm` : '-'}
                              </td>
                              <td>
                                <span
                                  className={`badge ${source.is_validated ? 'bg-light-success' : 'bg-light-warning'}`}
                                >
                              ...
                              <td>
                                <div className="btn-group">
                                  ...
                                  <button
                                    className="btn btn-sm btn-link-secondary touch-target"
                                    title="Edit"
                                  >
