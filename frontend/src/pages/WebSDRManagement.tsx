                        ...
                        return (
                          <tr key={websdr.id}>
                            ...
                            <td>
                              {responseTime > 0 ? (
                                <span
                                  className={`badge ${responseTime < 200 ? 'bg-light-success' : responseTime < 500 ? 'bg-light-warning' : 'bg-light-danger'}`}
                                >
                                  {responseTime}ms
                                </span>
                              ) : (
                            ...
                            <td>
                              <span
                                className={`badge ${websdr.is_active ? 'bg-light-primary' : 'bg-light-secondary'}`}
                              >
                        ...
                        <table className="table table-sm">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <span
                                  className={`badge ${websdr.is_active ? 'bg-light-success' : 'bg-light-secondary'}`}
                                >
                                  {websdr.is_active ? 'Yes' : 'No'}
                                </span>
                              </td>
                          ...
                          <table className="table table-sm">
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <span
                                    className={`badge ${health.status === 'online' ? 'bg-light-success' : 'bg-light-danger'}`}
                                  >
                                    {health.status}
                                  </span>
                                </td>
