                                    ...
                                    <div className="mb-3">
                                        ...
                                        <div className="form-check">
                                            <input
                                                ...
                                                onChange={(e) => setExportForm({ ...exportForm, include_settings: e.target.checked })}
                                            />
                                        ...
                                        <div className="form-check">
                                            <input
                                                ...
                                                onChange={(e) => setExportForm({ ...exportForm, include_sources: e.target.checked })}
                                            />
                                        ...
                                        <div className="form-check">
                                            <input
                                                ...
                                                onChange={(e) => setExportForm({ ...exportForm, include_websdrs: e.target.checked })}
                                            />
                                        ...
                                        <div className="form-check">
                                            <input
                                                ...
                                                onChange={(e) => setExportForm({ ...exportForm, include_sessions: e.target.checked })}
                                            />
                                            ...
                                            <div className="alert alert-success mb-3">
                                                ...
                                                <div className="mt-2">
                                                    <small className="d-block">
                                                        Version: {importFile.metadata.version}
                                                    </small>
                                                    <small className="d-block">
                                                ...
                                                {importFile.sections.settings && (
                                                    <div className="form-check">
                                                        <input
                                                            ...
                                                            onChange={(e) => setImportForm({ ...importForm, import_settings: e.target.checked })}
                                                        />
                                                ...
                                                {importFile.sections.sources && (
                                                    <div className="form-check">
                                                        <input
                                                            ...
                                                            onChange={(e) => setImportForm({ ...importForm, import_sources: e.target.checked })}
                                                        />
                                                ...
                                                {importFile.sections.websdrs && (
                                                    <div className="form-check">
                                                        <input
                                                            ...
                                                            onChange={(e) => setImportForm({ ...importForm, import_websdrs: e.target.checked })}
                                                        />
                                                ...
                                                {importFile.sections.sessions && (
                                                    <div className="form-check">
                                                        <input
                                                            ...
                                                            onChange={(e) => setImportForm({ ...importForm, import_sessions: e.target.checked })}
                                                        />
                                            ...
                                            <div className="mb-3">
                                                <div className="form-check">
                                                    <input
                                                        ...
                                                        onChange={(e) => setImportForm({ ...importForm, overwrite_existing: e.target.checked })}
                                                    />
