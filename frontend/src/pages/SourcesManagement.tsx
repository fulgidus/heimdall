  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const sourceData: KnownSourceCreate | KnownSourceUpdate = {
        ...
        error_margin_meters: formData.error_margin_meters
          ? parseFloat(formData.error_margin_meters)
          : undefined,
      };
              ...
              <div className="card-body">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    {formErrors.frequency_hz && (
                      <div className="invalid-feedback">{formErrors.frequency_hz}</div>
                    )}
                    <small className="text-muted">
                      Optional - Can be unknown for amateur stations
                    </small>
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      onChange={e =>
                        setFormData({ ...formData, error_margin_meters: e.target.value })
                      }
                      placeholder="50"
                    />
                    {formErrors.error_margin_meters && (
                      <div className="invalid-feedback">{formErrors.error_margin_meters}</div>
                    )}
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <p className="text-danger mb-0">
                  ...
                  This action cannot be undone. Sources referenced by recording sessions cannot be
                  deleted.
                </p>
              </div>
