    ...
    const menuSections: MenuSection[] = [
        {
            caption: 'Navigation',
            items: [
                { label: 'Dashboard', path: '/dashboard', icon: 'ph-house-line' },
            ]
        },
        {
        ...
        },
        {
            ...
            items: [
                ...
                { label: 'Import/Export', path: '/import-export', icon: 'ph-arrow-square-out' },
            ]
        },
    ];
                            ...
                            {menuSections.map((section, idx) => (
                                <React.Fragment key={idx}>
                                    ...
                                    {section.items.map((item, itemIdx) => (
                                        <li key={itemIdx} className={`pc-item ${isActivePath(item.path) ? 'active' : ''}`}>
                        ...
                        <ul className="list-unstyled">
                            <li className="dropdown pc-h-item">
                                ...
                                <div className="dropdown-menu dropdown-menu-end pc-h-dropdown">
                                    ...
                                    <div className="dropdown-body text-wrap header-notification-scroll position-relative" style={{ maxHeight: '250px' }}>
                            ...
                            <li className="dropdown pc-h-item header-user-profile">
                                ...
                                <div className="dropdown-menu dropdown-menu-end pc-h-dropdown">
                                    ...
                                    <div className="dropdown-body">
                                        <div className="profile-notification-scroll position-relative" style={{ maxHeight: '250px' }}>
