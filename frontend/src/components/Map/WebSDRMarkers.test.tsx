...
describe('WebSDRMarkers', () => {
    ...
    describe('Marker Creation', () => {
        ...
        it('should create markers with correct coordinates', () => {
            ...
            expect(markerInstances[1].setLngLat).toHaveBeenCalledWith([9.1900, 45.4642]);
    ...
    describe('Marker Styling', () => {
        it('should style online markers with green color', () => {
            ...
            render(
                <WebSDRMarkers
                    map={mockMap}
                    websdrs={onlineWebSDRs}
                    healthStatus={onlineHealthStatus}
                />
            );
        ...
        it('should style offline markers with red color', () => {
            ...
            render(
                <WebSDRMarkers
                    map={mockMap}
                    websdrs={offlineWebSDRs}
                    healthStatus={offlineHealthStatus}
                />
            );
        ...
        it('should style unknown status markers with yellow color', () => {
            ...
            render(
                <WebSDRMarkers
                    map={mockMap}
                    websdrs={unknownWebSDRs}
                    healthStatus={emptyHealthStatus}
                />
            );
        ...
        it('should handle WebSDR with null SNR', () => {
            ...
            render(
                <WebSDRMarkers
                    map={mockMap}
                    websdrs={[mockWebSDRs[0]]}
                    healthStatus={healthWithNullSNR}
                />
            );
        ...
        it('should handle WebSDR with zero SNR', () => {
            ...
            render(
                <WebSDRMarkers
                    map={mockMap}
                    websdrs={[mockWebSDRs[0]]}
                    healthStatus={healthWithZeroSNR}
                />
            );
