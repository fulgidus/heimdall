                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div className="space-y-3">
                                        <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
                                            <h3 className="text-sm font-semibold text-slate-400 mb-3">Session Information</h3>
                                            ...
                                            <div className="space-y-2 text-sm">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-white">{formatDuration(session.duration_seconds)}</span>
                                                </div>
                                                    ...
                                                    {session.source_latitude && session.source_longitude && (
                                                        <div>
                                                            ...
                                                            <span className="text-white ml-2">
                                                                {session.source_latitude.toFixed(6)}, {session.source_longitude.toFixed(6)}
                                                            </span>
                                                        </div>
                                                    )}
                                                </div>
                                        ...
                                        <div className="bg-slate-800 rounded-lg p-4 border border-slate-700">
                                            ...
                                            <div className="space-y-2 text-sm">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-white ml-2 capitalize">{session.approval_status}</span>
                                                </div>
                                                
                                                {session.celery_task_id && (
                                                    <div>
                                                        <span className="text-slate-400">Task ID:</span>
                                                        <span className="text-white ml-2 font-mono text-xs">{session.celery_task_id}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
