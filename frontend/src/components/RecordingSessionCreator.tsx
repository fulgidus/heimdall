      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400">Common values: 145.500 (2m), 433.000 (70cm)</p>
          </div>
          ...
          <div className="bg-blue-900/20 border border-blue-800 rounded-lg p-3">
            <p className="text-xs text-blue-300">
              💡 <strong>Tip:</strong> Sessions are queued and processed sequentially. You'll see
              the status update in real-time.
            </p>
          </div>
        </form>
      </CardContent>
