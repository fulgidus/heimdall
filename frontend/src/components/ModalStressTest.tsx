...
const ModalStressTest: React.FC = () => {
  ...
  return (
    <div className="container mt-5">
      <div className="card">
        ...
        <div className="card-body">
          <p className="text-muted">
            This test rapidly opens and closes modals to verify the Portal-based implementation
          ...
          <div className="d-flex gap-2">
            ...
            <button className="btn btn-warning" onClick={runStressTest}>
      ...
      {isModalOpen && (
        <SessionEditModal session={mockSession} onSave={handleSave} onClose={handleCloseModal} />
      )}
    </div>
  );
};
