...
describe('SessionEditModal', () => {
  ...
  describe('Portal Rendering', () => {
    it('should render modal using React Portal', () => {
      render(<SessionEditModal session={mockSession} onSave={mockOnSave} onClose={mockOnClose} />);
    ...
    it('should prevent body scroll when modal is open', () => {
      ...
      const { unmount } = render(
        <SessionEditModal session={mockSession} onSave={mockOnSave} onClose={mockOnClose} />
      );
  ...
  describe('User Interactions', () => {
    ...
    it('should display error message when save fails', async () => {
      ...
      render(
        <SessionEditModal session={mockSession} onSave={mockOnSaveError} onClose={mockOnClose} />
      );
    ...
    it('should disable buttons while saving', async () => {
      ...
      render(<SessionEditModal session={mockSession} onSave={slowSave} onClose={mockOnClose} />);
