                    ...
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">
                                <i className={`ph ${mode === 'create' ? 'ph-plus-circle' : 'ph-pencil-simple'} me-2`}></i>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-4 mb-3">
                                            ...
                                            <input
                                                ...
                                                placeholder="120"
                                            />
                                            {errors.altitude_asl && <div className="invalid-feedback">{errors.altitude_asl}</div>}
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                            />
                                            {errors.timeout_seconds && <div className="invalid-feedback">{errors.timeout_seconds}</div>}
                                        ...
                                        <div className="col-md-6 mb-3">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                            />
                                            {errors.retry_count && <div className="invalid-feedback">{errors.retry_count}</div>}
