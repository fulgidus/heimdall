...
describe('Dashboard Store (Zustand)', () => {
  ...
  describe('fetchWebSDRs Action', () => {
    ...
    it('should handle fetchWebSDRs error gracefully', async () => {
      ...
      await expect(useDashboardStore.getState().fetchWebSDRs()).rejects.toThrow(errorMessage);
    });
  });
  ...
  describe('fetchServicesHealth Action', () => {
    ...
    it('should handle fetchServicesHealth error gracefully', async () => {
      ...
      await expect(useDashboardStore.getState().fetchServicesHealth()).rejects.toThrow(
        errorMessage
      );
    });
  });
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle network timeout', async () => {
      vi.mocked(webSDRService.getWebSDRs).mockRejectedValue(new Error('Network timeout'));

      // fetchWebSDRs throws errors
      await expect(useDashboardStore.getState().fetchWebSDRs()).rejects.toThrow('Network timeout');
    });
